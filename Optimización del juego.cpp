...
//Optimizar checkEnemyStatus1() y 2() pasamos todos los atributos del enemigo como parámetro por referencia
// a enemyHP, enemyName y enemyIsAlive. Con lo cual con una sola función comprueba el estado de cualquier enemigo.

bool checkEnemyStatus(int& enemyHP, string& enemyName, bool& enemyIsAlive) {
    if (enemyHP <= 0) {
